  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formDetail"  method="post" action="<?=base_url('detail')?>" >
...
<script>
  $(document).ready(function(){
    ...
    $('button#btn-kirim').on('click', function(){
        $('form#formDetail').submit();
    });

    $('button#btn-tambah').on('click', function(){
      $('#modalForm').modal('show');
      $('form#formDetail').trigger('reset');
    ...
    $('table#table-pelanggan').on('click', '.btn-edit', function(){
        ...
        $.get(`${baseurl}/detail/${id}`).done((e)=>{
          $('input[name=id]').val(e.id);
          $('input[name=produk_id]').val(e.produk_id);
          $('input[name=harga_jual]').val(e.harga_jual);
          $('input[name=jumlah]').val(e.jumlah);
          $('#modalForm').modal('show');
    ...
    $('table#table-pelanggan').on('click', '.btn-hapus', function(){
      ...
      if(konfirmasi === true){
        ...
        $.post(`${baseurl}/detail`, {id:_id, _method:'delete'}).done(function(e){
          $('table#table-pelanggan').DataTable().ajax.reload();
        });
      }
    });
