  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formRuangan"  method="post" action="<?=base_url('ruangan')?>" >
...
<script>
  $(document).ready(function(){
    ...
    $('button#btn-kirim').on('click', function(){
        $('form#formRuangan').submit();
    });

    $('button#btn-tambah').on('click', function(){
      $('#modalForm').modal('show');
      $('form#formRuangan').trigger('reset');
    ...
    $('table#table-pelanggan').on('click', '.btn-edit', function(){
        ...
        $.get(`${baseurl}/ruangan/${id}`).done((e)=>{
          $('input[name=id]').val(e.id);
          $('input[name=nama_ruangan]').val(e.nama_ruangan);
    ...
    $('table#table-pelanggan').on('click', '.btn-hapus', function(){
      ...
      if(konfirmasi === true){
        ...
        $.post(`${baseurl}/ruangan`, {id:_id, _method:'delete'}).done(function(e){
          $('table#table-pelanggan').DataTable().ajax.reload();
        });
      }
    });
